...
tbl_barang.addMouseListener(new java.awt.event.MouseAdapter() {
 ...
 SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String formattedTanggalMasuk = dateFormat.format(date_masuk.getSelectedDate().getTime());
        String formattedExp = dateFormat.format(date_exp.getSelectedDate().getTime());
    ...
    String sql = "UPDATE tb_barang SET nama='" + txt_nama.getText() + "',"
               ...
               + "Stok='" + txt_jumlah.getText() + "',"
               + "tgl_masuk='" + formattedTanggalMasuk + "',"
               + "exp='" + formattedExp + "' "
    ...
    GetData();
    //mengeksekusi ketika setelah di update kolom isi kembali ke 0
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 50, -1, -1));
        ...
        jPanel1.add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 90, 70, -1));
        ...
        jPanel1.add(btn_keluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 70, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 580, 190));
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        if (btn_simpan.getText().equals("UPDATE")) {
    ...
    private void tbl_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_barangMouseClicked
        ...
        //mengeksekusi ketika data sudah ditekan akan keluar tombol diperbaharui
